...
namespace Bug_tracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Property,Changed,OldValue,NewValue,TicketId,UserId")] TicketHistory ticketHistory)
        {
            ...
            ViewBag.TicketId = new SelectList(db.Tickets, "Id", "Name", ticketHistory.TicketId);
            ViewBag.UserId = new SelectList(db.Users, "Id", "Name", ticketHistory.UserId);
            return View(ticketHistory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Property,Changed,OldValue,NewValue,TicketId,UserId")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
